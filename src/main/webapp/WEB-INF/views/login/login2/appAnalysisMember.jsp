...
function getChart(){
	...
	if($('#meal_type').val()){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"${pageContext.request.contextPath}/getChartLabel",
			data: {
	            'id':$('#member_name').val(),
...
//  chart - data
	if($('#meal_type').val()){
		$.ajax({
			type:"post",
			dataType:"json",
			url:"${pageContext.request.contextPath}/getChartData",
			data: {
	            'id':$('#member_name').val(),
	            'meal_type': $('#meal_type').val()
	         },
